...
function DeleteConfirmModal({ isDeleteModalOpen, setIsDeleteModalOpen, clearHistoryAndMessages }) {
    return (
                                ...
                                <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                    ...
                                    <div className="mt-2">
                                        <p className="text-sm text-gray-500">
                                            ...
                                            This will remove all your data and start a fresh chat.
